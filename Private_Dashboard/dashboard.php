        ...
        <div class="col-md-9 mb-4 mx-auto">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
require_once("include/connection.php");
$sql ="SELECT *,count(DEPART) as count FROM upload_files group by DEPART;";
...
?>
<CENTER><h3 class="page-header" >Count Per Department </h3></CENTER>  
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <?php
require_once("include/connection.php");
$sql1 ="SELECT *,count(yearp) as count FROM upload_files group by yearp;";
...
?>
<CENTER><h3 class="page-header" >Count Per Year  </h3></CENTER>  
        ...
        <div class="col-md-9 mb-4 mx-auto">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
require_once("include/connection.php");
$sql2 ="SELECT *,count(REVIEW) as count FROM upload_files group by REVIEW;";
...
?>
<CENTER><h3 class="page-header" >Count Per Indexes  </h3></CENTER>  
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <?php
require_once("include/connection.php");
$sql3 ="SELECT *,count(NI) as count FROM upload_files group by NI;";
...
?>
<CENTER><h3 class="page-header" >Count Per Publications  </h3></CENTER>  
