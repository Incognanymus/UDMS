...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD,ANAME,YEARP,ISSN,LINK,DEPART,NI,REVIEW FROM upload_files group by NAME DESC") or die (mysqli_error($con));
