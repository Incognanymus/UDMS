...
<input class="input" name="aname" type="text" value="" required>
<label>Year of Publication:</label>
<input class="input" name="yearp" type="text" value="" required>
<label>ISSN/ISBN Number:</label>
<input class="input" name="issn" type="text" value="" required>
<label>UGC Recognized Link:</label>
<input class="input" name="link" type="text" value="" required>
...
<label for="ni">Select One:</label>
<select name="ni" id="ni" required>
  <option value="National">National</option>
  <option value="International">International</option>
</select>
<label for="review">Select Index:</label>
<select name="review" id="review" required>
  ...
  <option value="Pear Reviewed">Pear Reviewed</option>
</select>
          ...
          <footer style="font-size: 12px"><b>Allowed Size : </b><font color="red"><b>1 MB</b></font></footer>
          <footer style="font-size: 12px"><b>Allowed File Type : </b><font color="red"><b>.pdf</b></font></footer>
        </form>
      </div>
    </div>
  </div>
